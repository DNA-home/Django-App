...
def home(request):
    ...
    for room in rooms:
        ...
        participant_count.append({'count':participants.count(),'room':room})
    ...
    context={'rooms':rooms,"topics":topics, 'room_count':room_count,'participant_count':participant_count,
    'tot_messages': messages}
